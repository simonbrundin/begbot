...
import { Ignore, Options as Options$2 } from "ignore";
import { ChokidarOptions } from "chokidar";
import { CorsOptions, H3CorsOptions } from "h3";
import { NuxtLinkOptions } from "nuxt/app";
import { FetchOptions } from "ofetch";
import { Options as Options$3 } from "autoprefixer";
import { Options as Options$4 } from "cssnano";
...
import { Options as Options$5 } from "pug";
...
import { RouteLocationRaw, RouteRecordRaw, RouterHistory, RouterOptions as RouterOptions$1 } from "vue-router";
...
interface NuxtTemplate<Options$7 = TemplateDefaultOptions> {
...
interface ResolvedNuxtTemplate<Options$7 = TemplateDefaultOptions> extends NuxtTemplate<Options$7> {
  filename: string;
  dst: string;
  modified?: boolean;
}
interface NuxtTypeTemplate<Options$7 = TemplateDefaultOptions> extends Omit<NuxtTemplate<Options$7>, "write" | "filename"> {
  filename: `${string}.d.ts`;
  write?: true;
}
type _TemplatePlugin<Options$7> = Omit<NuxtPlugin, "src"> & NuxtTemplate<Options$7>;
interface NuxtPluginTemplate<Options$7 = TemplateDefaultOptions> extends _TemplatePlugin<Options$7> {}
interface NuxtApp {
  ...
  postcss: {
    ...
    */
    plugins: Record<string, unknown> & {
      autoprefixer?: false | Options$3;
      cssnano?: false | Options$4;
    };
  };
  router: {
    /**
