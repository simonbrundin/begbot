...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Inventory and listing management"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Begbot Dashboard"};
