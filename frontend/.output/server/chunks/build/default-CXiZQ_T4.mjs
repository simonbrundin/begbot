...
import { _ as __nuxt_component_0$1 } from './nuxt-link-DJsUO_d8.mjs';
...
const __nuxt_component_0 = Object.assign(_sfc_main$1, { __name: "LoadingSpinner" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LoadingSpinner = __nuxt_component_0;
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span${_scopeId}>Meddelanden</span>`);
          } else {
            return [
              createVNode("span", null, "Meddelanden")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=default-CXiZQ_T4.mjs.map
